...
const DATA = {
  ...
  work: [
    {
      ...
      description:
        "Working on AI product which is an AI assistant mainly for ios and android application",
    },
    {
      company: "VSC Project ",
  ...
  projects: [
    ...
    },
    {
      ...
      active: true,
      description:
        "An AI-powered intelligent chat assistant application featuring voice recognition and advanced conversational AI. Developed for iOS and Android platforms with a sophisticated backend architecture supporting multiple LLM providers for enhanced contextual understanding and real-time responses.",
      technologies: [
        "React.js",
        "FastAPI",
        "Redis",
